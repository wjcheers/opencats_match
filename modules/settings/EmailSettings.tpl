                            ...
                            <table class="editTable" width="700">
                                ...
                                <tr id="fromAddressRow">
                                    ...
                                    <td class="tdData">
                                        ...
                                        <input type="checkbox" name="statusChangeJechoing" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_JECHOING]==1): ?>checked<?php endif; ?>>Status Change: Jechoing<br />
                                        <input type="checkbox" name="statusChangeVerified" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_VERIFIED]==1): ?>checked<?php endif; ?>>Status Change: Verified<br />
                                        <input type="checkbox" name="statusChangeAwaiting" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_AWAITING]==1): ?>checked<?php endif; ?>>Status Change: Awaiting<br />
                                        <input type="checkbox" name="statusChangeUploaded" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_UPLOADED]==1): ?>checked<?php endif; ?>>Status Change: Uploaded<br />
