                            ...
                            <table class="editTable" width="700">
                                ...
                                <tr id="fromAddressRow">
                                    ...
                                    <td class="tdData">
                                        ...
                                        <input type="checkbox" name="statusChangeConfirmed" <?php if($this->candidateJoborderStatusSendsMessage[PIPELINE_STATUS_CONFIRMED]==1): ?>checked<?php endif; ?>>Status Change: Confirmed<br />
