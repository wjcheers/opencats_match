...
class SettingsUI extends UserInterface
{
    ...
    private function onAddUser()
    {
        ...
        $permission     = $this->getTrimmedInput('permission', $_POST);
        ...
        $userID = $users->add(
            $lastName, $firstName, $email, $username, $password, $accessLevel, $eeoIsVisible, $permission
        );
    ...
    private function onEditUser()
    {
        ...
        if (!$users->update($userID, $lastName, $firstName, $email, $username,
            $accessLevel, $eeoIsVisible, $permission))
        {
    ...
    private function onEmailSettings()
    {
        ...
        $candidateJoborderStatusSendsMessage[PIPELINE_STATUS_JECHOING] = (UserInterface::isChecked('statusChangeJechoing', $_POST) ? 1 : 0);
