...
<?php TemplateUtility::printTabs($this->active); ?>
    <div id="main">
        ...
        <div id="contents"<?php echo !$this->numActivities ? ' style="background-color: #E6EEFF; padding: 0px;"' : ''; ?>>
            ...
            <br /><br />
            <table cellpadding="0" cellspacing="0" border="0" width="1256">
                <tr>
                <td style="padding-left: 62px;" align="center" valign="center">

                    <div style="text-align: center; width: 1000px; line-height: 22px; font-size: 18px; font-weight: bold; color: #666666; padding-bottom: 20px;">
