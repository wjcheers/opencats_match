    ...
    <div id="main">
        ...
        <div id="contents">
            ...
            <table class="searchTable" id="searchTable">
                <tr>
                    <td>
                        <form name="searchForm" id="searchForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=search" method="post" onsubmit="result = checkSearchForm(document.searchForm); if(result) {document.getElementById('searchCompanies').disabled = true; document.getElementById('searchCompanies').value='Searching, please wait...';} return result;" autocomplete="off" enctype="multipart/form-data">
