...
function showQuickActionAddToList()
{
    ...
    showPopWin(CATSIndexName + '?m=lists&a=quickActionAddToListModal&dataItemType='+_singleQuickActionMenuDataItemType+'&dataItemID='+_singleQuickActionMenuDataItemID, 750, 570, null);
}
...
function showQuickActionAddToPipeline()
{
    ...
    showPopWin(CATSIndexName + '?m=candidates&a=considerForJobSearch&candidateID='+_singleQuickActionMenuDataItemID, 1050, 540, null);
}
