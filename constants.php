...
define('PIPELINE_STATUS_NOINTENTIONTOCHANGE',       260);
define('PIPELINE_STATUS_NOTINTERESTEDINCOMPANY',    261);
define('PIPELINE_STATUS_NOTINTERESTEDINTECHNOLOGY', 262);
define('PIPELINE_STATUS_MAYNOTPASSTHEINTERVIEW',    263);
define('PIPELINE_STATUS_ALREADYCONTACTEDBYCLIENT',  264);
define('PIPELINE_STATUS_QUALIFYING',         300);
define('PIPELINE_STATUS_JECHOING',           301);
define('PIPELINE_STATUS_VERIFIED',           350);
define('PIPELINE_STATUS_AWAITING',           360);
define('PIPELINE_STATUS_UPLOADED',           370);
...
define('PIPELINE_STATUS_CLIENTNOTRESPONSE',         750);
