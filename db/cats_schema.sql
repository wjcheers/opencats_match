...
INSERT INTO `activity_type` VALUES (100,'Call'),(200,'Email'),(300,'Meeting'),(400,'Other'),(500,'Call (Talked)'),(600,'Call (LVM)'),(700,'Call (Missed)'),(800,'Arrange'),(900,'Confirm'),(1000,'Drifting'),(1100,'IM (Linkedin)',(1200,'Interview'));
UNLOCK TABLES;
...
CREATE TABLE `candidate` (
  ...
  `is_agreement` int(1) default NULL,
  `is_resume` int(1) default NULL,
  ...
  `birth_year` varchar(32) default NULL,
  `highest_degree` varchar(256) default NULL,
  ...
  `link1` varchar(512) default NULL,
  `link2` varchar(512) default NULL,
  `link3` varchar(512) default NULL,
  ...
  `job_level` varchar(128) default NULL,
...
CREATE TABLE `user` (
  ...
  `gmail_password` varchar(128) default NULL,
  PRIMARY KEY  (`user_id`),
  KEY `IDX_site_id` (`site_id`),
  KEY `IDX_first_name` (`first_name`),
  KEY `IDX_last_name` (`last_name`),
