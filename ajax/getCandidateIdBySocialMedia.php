 ...
 *
 *
 * $Id: getCandidateIdBySocialMedia.php 3078 2007-09-21 20:25:28Z will $
 */
...
{
    $social['skype'] = $_REQUEST['skype'];
}
if (isset($_REQUEST['wechat']))
{
    $social['wechat'] = $_REQUEST['wechat'];
}
if (isset($_REQUEST['line']))
{
    $social['line'] = $_REQUEST['line'];
}
if (isset($_REQUEST['qq']))
{
    $social['qq'] = $_REQUEST['qq'];
}
